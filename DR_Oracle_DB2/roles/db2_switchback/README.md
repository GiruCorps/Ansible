Automatizacion de Ansible: Switchback IBM Db2 HADR
======================================

## Descripcion del caso de uso
Este rol permite realizar un Switchback (movimiento controlado) de una instancia específica de IBM Db2 para bases de datos replicadas mediante HADR, desplegadas sobre AIX, desde DCA hacia DCP.
...
* `instance`: Define el nombre de la instancia a la cual se va a afectar durante el switchback
    - **Tipo**: string
    - **Required**: True
